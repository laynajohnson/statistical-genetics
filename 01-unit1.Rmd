...
This makes the significance threshold pretty small ($5 * 10^{-5}$). But a typical GWAS will involve hundreds of thousands or even billions of SNPs. So our threshold can get pretty tiny for this many hypothesis tests (e.g. $5 * 10^{-11}$). However, this might be too conservative and lead us to make type 2 errors. 
