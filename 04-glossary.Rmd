...
There are many terms that come along with talking about genetic data. The following are some terms to remember as you read this summary. Terms are generally listed in the order which they appear in each unit.
...
-   [*Principal Component Analysis*]{.underline}: a method of dimension reduction to keep the most variation from our original data by weighting the variables together into new components (PCs).
...
-   [*Directed Acyclic Graph*]{.underline}: also known as a causal graph. These graphs show how one believes variables are related to each other
...
-   [*OLS*]{.underline}: stands for ordinary least squares. Essentially another name for linear regression
