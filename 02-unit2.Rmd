...
Here is another thing to think about, what happens if our $y = 0$ or if $X^TZ = 0$? Here is what this idea looks like in a DAG, but also try proving this like we did together before.
